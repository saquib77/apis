...
public class UserService {
	...
	public Optional<User> addUser(User user){
		...
		if(userDb.isEmpty()) {
			...
			userDao.setCreated(new Date());
			userDao.setUpdated(new Date());
			userAdDao.setCreated(new Date());
			userAdDao.setUpdated(new Date());
	...
	public Optional<User> updateUserDetails(UUID id, User user){
		...
		if(userDaoDb.isPresent()) {
			...
			userDetails.setUpdated(new Date());
			userDetails.getAddress().setUpdated(new Date());
